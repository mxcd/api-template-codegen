...
function isModel(models: any, s: any) {
  for (const model of models) {
    if (model.upperCamelCaseName === s || model.lowerCamelCaseName === s || model.upperCamelCasePluralName === s || model.lowerCamelCasePluralName === s)
      return true;
  }
  return false;
}

function getModel(models: any, s: any) {
  for (const model of models) {
    if (model.upperCamelCaseName === s || model.lowerCamelCaseName === s || model.upperCamelCasePluralName === s || model.lowerCamelCasePluralName === s)
      return model;
  }
...
function getField(model: any, name: any) {
...
console.log(`Rendering types.ejs`);
...
console.log(`Rendering operations.ejs`);
...
console.log(`Rendering inputs.ejs`);
...
for (const model of models) {
  console.log(`Render controller for ${model.upperCamelCaseName}`);
...
console.log(`Rendering resolvers.ejs`);
